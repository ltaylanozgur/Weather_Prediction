MID BOOTCAMP PROJECT: Analysis and prediction of average temperature based on meteorological data

Tableau link: https://public.tableau.com/views/Mid_bootcamp_project_16647282235460/Dusseldorf_temperature2000-2010?:language=en-US&:display_count=n&:origin=viz_share_link\
...
Presentation: power point and pdf files of the presentation
Python: project dataset and Jupiter notebook (Mid_Bootcamp_Project)
SQL: mysql files of the project. Dusseldorf and Muenchen data are in "Model" folder.

Information about dataset is explained below. 
-----------------------------------------------------------------------------------------------------
